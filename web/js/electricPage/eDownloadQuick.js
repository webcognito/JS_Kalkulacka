...
function downloadDetailCalculation() {
  // Retrieve Array from localStorage
      const storedArray = localStorage.getItem('eResultsQuick');
          ...
          {   
              ...
              table: {
                  ...
                  body: [
                            ...
                            [
                              {text: 'Spotřeba Elektřiny', colSpan: 6, fillColor: '#fffe72', border: [true, false, true, false], style: 'firstRow'}, 
                              {},  
                              {},  
                              {}, 
                              {},
                            ...
                            [
                              {text: 'Vysoký Tarif', colSpan: 3, bold: true, border: [true, false, true, false], style: 'firstRow'}, 
                              {},
                              {},
                              {text: 'Nizky Tarif', colSpan: 3, bold: true, border: [true, false, true, false], style: 'firstRow'}, 
                              {},  
                              {}
                            ],
                            [
...
function downloadComparision() {
  ...
  const storedArray = localStorage.getItem('eResultsQuick');
  const eResultsQuick = JSON.parse(storedArray);

  // Columns display order
  let columns = ['company', 'contractDuration', 'distCode', 'usageVT', 'usageNT', 'numberOfMonths', 'totalCost'];
          ...
          {   
              ...
              table: {
                  ...
                  body: buildTableBody(
                          ...
                          {text: 'Dist. Sazba', fontSize: 10, color: 'white', alignment: 'center', alignmentChild: 'center'},
