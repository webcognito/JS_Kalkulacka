                ...
                table:{
                    ...
                    body: [
                            ...
                            [
                                ...
                                {}, 
                                {text: foundResult.usageRange, colSpan: 2, border: [true, false, true, true], alignment: 'center'}, 
                                {}
                            ],
                            [
                            ...
                            [
                                ...
                                {},
                                {}, 
                                {text: 'Celková Cena za ' + 'No' + ' měsícu', colSpan: 3, fillColor: '#ff9999', border: [true, false, true, false], style: 'firstRow'}, 
                                {}, 
                                {}
                            ],
                            [
...
// Download Comparison Table / id="btnDownload" 
function downloadComparision() {
  ...
  // Format: [{company: "PRE", contract: "1 year", mwhUsage: "3", numberOfMonths: "12", totalCost: "2400", advancePay: "200"}]
    const gResults = getFromLocalStorage();
